...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
        ...
        <form action="{{ route('administrator.product.update', $product->id) }}" method="POST" class="form"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="name" class="form-control form-control-solid" name="name"
                        placeholder="Introduce el nombre del producto" value="{{ $product->name }}" required />
                </div>
                <div class="form-group">
                    <label>Descripción</label>
                    <input type="name" class="form-control form-control-solid" name="description"
                        placeholder="Introduce la descripcion del producto" value="{{ $product->description }}"
                        required />
                </div>
                <div class="form-group">
                    <label>Precio</label>
                    <input type="number" class="form-control form-control-solid" name="price"
                        placeholder="Introduce el precio del producto" value="{{ $product->price }}" required />
                </div>
                <div class="form-group">
                    <label>Inventario</label>
                    <input type="number" class="form-control form-control-solid" name="stock"
                        placeholder="Introduce el stock del producto" value="{{ $product->stock }}" required />
                </div>
                <div class="form-group">
                    <label>Imagen</label>
                    <div></div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('administrator.product.index') }}" type="reset" class="btn btn-secondary">Cancelar</a>
            </div>
        </form>
    </div>
