				...
				<ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
					...
					<li class="nav-item">
						{{-- <a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab"> --}}
                            ...
                            <a href="{{route('administrator.menu')}}" class="nav-link py-4 px-6 active" > 
                            @else
                            <a href="{{route('administrator.menu')}}" class="nav-link py-4 px-6" >  
                            @endif
					...
					<li class="nav-item mr-3">
						{{-- <a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab"> --}}
                            @if (\Request::is('administrador/categorias') || \Request::is('administrador/categoria/*'))
                            <a href="{{route('administrator.categorie.index')}}" class="nav-link py-4 px-6 active" >   
                            @else
                            <a href="{{route('administrator.categorie.index')}}" class="nav-link py-4 px-6" >   
                            @endif
                            Categorias
						</a>
					</li>
					...
					<li class="nav-item mr-3">
						{{-- <a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab"> --}}
                            @if (\Request::is('administrador/productos') || \Request::is('administrador/producto/*'))
                            <a href="{{route('administrator.product.index')}}" class="nav-link py-4 px-6 active" > 
                            @else
                            <a href="{{route('administrator.product.index')}}" class="nav-link py-4 px-6" >   
                            @endif
					...
					<li class="nav-item mr-3">
                         {{-- <a href="#" class="nav-link py-4 px-6" data-toggle="tab" data-target="#kt_header_tab_2" role="tab"> --}}
						@if (\Request::is('administrador/empresas_envio') || \Request::is('administrador/empresa_envio/*'))
                        <a href="{{route('administrator.deliveryCompany.index')}}" class="nav-link py-4 px-6 active" > 
                            @else
                        <a href="{{route('administrator.deliveryCompany.index')}}" class="nav-link py-4 px-6" > 
                        @endif
                            Envios
						</a>
					</li>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M8.56066017,16.6819805 L10.6819805,14.5606602 C11.267767,13.9748737 12.2175144,13.9748737 12.8033009,14.5606602 L14.9246212,16.6819805 C15.5104076,17.267767 15.5104076,18.2175144 14.9246212,18.8033009 L12.8033009,20.9246212 C12.2175144,21.5104076 11.267767,21.5104076 10.6819805,20.9246212 L8.56066017,18.8033009 C7.97487373,18.2175144 7.97487373,17.267767 8.56066017,16.6819805 Z M8.56066017,4.68198052 L10.6819805,2.56066017 C11.267767,1.97487373 12.2175144,1.97487373 12.8033009,2.56066017 L14.9246212,4.68198052 C15.5104076,5.26776695 15.5104076,6.21751442 14.9246212,6.80330086 L12.8033009,8.9246212 C12.2175144,9.51040764 11.267767,9.51040764 10.6819805,8.9246212 L8.56066017,6.80330086 C7.97487373,6.21751442 7.97487373,5.26776695 8.56066017,4.68198052 Z" fill="#000000"/>
			    			...
			    			<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
			                    <form>
			    	                <!--begin::Header-->
    <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(
        {{asset('assets/media/misc/bg-1.jpg')}})">
        <!--begin::Title-->
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url(
                    '{{asset('assets/media/users/300_21.jpg')}}')"></div>
