...
<body id="kt_body" class="header-fixed subheader-enabled page-loading">
            ...
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
                ...
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    ...
                    <div class="login-signin">
                        ...
                        @endif
                        <form action="{{ route('administrator.login') }}" method="POST" class="form"
                            id="kt_login_signin_form">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <input
                                    class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                    type="text" placeholder="Correo electrónico" name="email" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <input
                                    class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                    ...
                    <div class="login-forgot">
                        <div class="mb-20">
                            ...
                            <p class="opacity-60">Ingrese su correo electrónico para restablecer su contraseña</p>
                        </div>
                        <form class="form" id="kt_login_forgot_form">
                            <div class="form-group mb-10">
                                <input
                                    ...
                                    type="text" placeholder="Correo electronico" name="email" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <button id="kt_login_forgot_submit"
                                    class="btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15 py-3 m-2">Enviar</button>
                                <button id="kt_login_forgot_cancel"
                                    class="btn btn-pill btn-outline-white font-weight-bold opacity-70 px-15 py-3 m-2">Cancelar</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    @if (Session::get('locale') == 'en')
        <script src="{{ asset('assets/js/pages/custom/login/login-general-en.js?v=7.0.6') }}"></script>
    @else
